...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static String sendPostParams(String... params) {
	 ...
	 * @return
	 */
	public static String sendGetParams(String reqURL, String... params) {
		...
		Log.v("shihu", sbd.toString());
		return sbd.toString();
	}
	public static String get(String url,String... parm){
	...
	public static String postPagram(String... src){
